...
// Toggle between light and dark only (no system mode).
...
// Determine the theme setting: "light" or "dark" only. Default is "light".
...
// Computed theme is the same as the setting (no system preference).
